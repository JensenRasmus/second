% This is program is taken from the source code of the article
% @article{Son_21,
...
%    author={Son, Nguyen Thanh and Absil, P.-A. and Gao, Bin and Stykel, Tatjana},
%    publisher={Society for Industrial & Applied Mathematics (SIAM)},
%    year={2021},
%   pages={1732-1757} 
%   }
% This code can also be found on the website of the author https://github.com/opt-gaobin/speig/
